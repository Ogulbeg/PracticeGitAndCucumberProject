...
Feature: Create calendar event
  ...
  Scenario: Create calendar event as sales manager
    ...
    And user verifies that description of new calendar event of new calendar event is"On this meeting we discuss what went well, what went wrong and what can be improved"And user verifies that description of new calendar event is "On this meeting we discuss what went well, what went wrong and what can be improved"
